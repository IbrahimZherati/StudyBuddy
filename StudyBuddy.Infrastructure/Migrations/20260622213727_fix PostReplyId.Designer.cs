...
namespace StudyBuddy.Infrastructure.Migrations
{
    ...
    [Migration("20260622213727_fix PostReplyId")]
    partial class fixPostReplyId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyBuddy.Domain.Entities.ClientUserGroupMessageRead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClientUserGroupMessageReads");
                });
            ...
            modelBuilder.Entity("StudyBuddy.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("StudyBuddy.Domain.Entities.ClientUserGroupMessageRead", b =>
                {
                    ...
                    b.HasOne("StudyBuddy.Domain.Entities.GroupMessage", "Message")
                        .WithMany("ClientUserGroupMessageReads")
            ...
            modelBuilder.Entity("StudyBuddy.Domain.Entities.GroupMessage", b =>
                {
                    b.Navigation("ClientUserGroupMessageReads");
                });
