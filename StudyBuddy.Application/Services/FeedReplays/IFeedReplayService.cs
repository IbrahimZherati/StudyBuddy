...
namespace StudyBuddy.Application.Services
{
     ...
     {
         Task<Result<GetFeedReplayDTO>> Create(int clientId ,CreateFeedReplayDTO feedreplayDTO);
         Task<Result<GetFeedReplayDTO>> Update(int clientId ,UpdateFeedReplayDTO feedreplayDTO);
