...
namespace StudyBuddy.Shared.AI
{
    public class AiPromt
    {
        ...
        public static string GetGenerateSummaryPromt(string text)
        {
            ...
            $"plz not make anything just get this summary in text with html tag so i can read it in front" ;
        }
        ...
        public static string GetGenerateFlashCard(string text, int take)
        {
            ...
            $"and plz not make anything just make it in json format {{Question : [the question],Answer : [the answer]}} and return in json list " + 
