...
namespace StudyBuddy.Shared.Helpers.ErrorMessages
{
    public class Error
    {
        ...
        public const string ArticleTypeAlreadyAlreadyExists = "ArticleType Already Exists";
        public const string CityAlreadyAlreadyExists = "City Already Exists";
        public const string ClientFileAlreadyAlreadyExists = "ClientFile Already Exists";
        public const string ClientUserAlreadyAlreadyExists = "ClientUser Already Exists";
        public const string ClientUserAvailableDayAlreadyAlreadyExists = "ClientUserAvailableDay Already Exists";
        public const string DayNotFound = "Day Not Found";
        public const string ClientUserGroupChatAlreadyAlreadyExists = "ClientUserGroupChat Already Exists";
        public const string ClientUserSkillAlreadyAlreadyExists = "ClientUserSkill Already Exists";
        public const string SkillNotFound = "Skill Not Found";
        public const string CountryAlreadyAlreadyExists = "Country Already Exists";
        public const string DayAlreadyAlreadyExists = "Day Already Exists";
        public const string EventAlreadyAlreadyExists = "Event Already Exists";
        public const string FeedAlreadyAlreadyExists = "Feed Already Exists";
        public const string FeedReplayAlreadyAlreadyExists = "FeedReplay Already Exists";
        public const string FeedNotFound = "Feed Not Found";
        public const string FriendAlreadyAlreadyExists = "Friend Already Exists";
        public const string FriendNotFound = "Friend Not Found";
        public const string FriendRequestAlreadyAlreadyExists = "FriendRequest Already Exists";
        public const string GroupChatAlreadyAlreadyExists = "GroupChat Already Exists";
        public const string GroupMessageAlreadyAlreadyExists = "GroupMessage Already Exists";
        public const string FromClientUserNotFound = "FromClientUser Not Found";
        public const string MajorAlreadyAlreadyExists = "Major Already Exists";
        public const string MessageAlreadyAlreadyExists = "Message Already Exists";
        public const string ToClientUserNotFound = "ToClientUser Not Found";
        public const string NoteAlreadyAlreadyExists = "Note Already Exists";
        public const string NotificationAlreadyAlreadyExists = "Notification Already Exists";
        public const string NotificationTypeAlreadyAlreadyExists = "NotificationType Already Exists";
        public const string PostAlreadyAlreadyExists = "Post Already Exists";
        public const string SkillAlreadyAlreadyExists = "Skill Already Exists";
        public const string UniversityAlreadyAlreadyExists = "University Already Exists";
